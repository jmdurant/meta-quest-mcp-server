...
|---|---|---|
| `META_APP_ID` | Yes | App ID from the Developer Dashboard API tab |
| `META_APP_SECRET` | Yes | App Secret from the Developer Dashboard API tab |
